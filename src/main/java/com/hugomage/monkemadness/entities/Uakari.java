...
public class Uakari extends Animal {

    public static final Ingredient BREEDITEM = Ingredient.of(Items.SUGAR_CANE, Items.MELON_SLICE, Items.HONEYCOMB);
    public Uakari(EntityType<? extends Animal> type, Level worldIn) {
        super(type, worldIn);
    }
    private static final EntityDataAccessor<Integer> DATA_VARIANT_ID = SynchedEntityData.defineId(Uakari.class, EntityDataSerializers.INT);
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageableEntity) {
        Uakari uakari = MMEntitysRegistry.UAKARI.get().create(serverWorld);
