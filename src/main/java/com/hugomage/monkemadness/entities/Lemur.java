...
public class Lemur extends Animal {
    ...
    public Lemur(EntityType<? extends Animal> type, Level worldIn) {
        super(type, worldIn);
    }
    private static final EntityDataAccessor<Integer> DATA_VARIANT_ID = SynchedEntityData.defineId(Lemur.class, EntityDataSerializers.INT);
    ...
    public boolean isJulien() {
        String s = ChatFormatting.stripFormatting(this.getName().getString());
        return s != null && (s.toLowerCase().contains("king") && s.toLowerCase().contains("julien"));
    }
