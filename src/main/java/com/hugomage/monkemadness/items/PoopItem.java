...
import com.hugomage.monkemadness.entities.Poop;
...
public class PoopItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level p_43142_, Player p_43143_, InteractionHand p_43144_) {
        ...
        if (!p_43142_.isClientSide) {
            Poop poop = new Poop(p_43142_, p_43143_);
            poop.setItem(itemstack);
            poop.shootFromRotation(p_43143_, p_43143_.getXRot(), p_43143_.getYRot(), 0.0F, 1.5F, 1.0F);
            p_43142_.addFreshEntity(poop);
        }
